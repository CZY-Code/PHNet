...
class LaneEval_Temporal(object):
    ...
    def settings(self, test_mode, iou):
        ...
        self.anno_dir = '/home/chengzy/MMA-TR-Net/evaluation/txt/anno_txt/'
        self.pred_dir = '/home/chengzy/MMA-TR-Net/evaluation/txt/pred_txt/'
        self.list_path = '/home/chengzy/MMA-TR-Net/evaluation/datalistVIL.txt'

        datalist = load_pickle('/home/chengzy/MMA-TR-Net/evaluation/datalistVIL')
    ...
    def eval_predictions(self):
        ...
        img_shape = load_pickle('/home/chengzy/MMA-TR-Net/evaluation/shape_list')
        if self.sequential:
...
# iou=0.8
# Ns: 3965, Nj: 1816, Nm: 1786, Rs: 0.5239857275009911, Rj: 0.23998942777851195, Rm: 0.2360248447204969
# total N_s N_j N_m ==> 3965 1816 1786
# ====================Results (datalistVIL.txt)====================
# Ns: 3965
# Nj: 1816
# Nm: 1786
# Rs: 0.5240
...
# iou=0.5
# Ns: 6394, Nj: 673, Nm: 500, Rs: 0.8449848024316109, Rj: 0.08893881326813796, Rm: 0.06607638430025109
# total N_s N_j N_m ==> 6394 673 500
# ====================Results (datalistVIL.txt)====================
# Ns: 6394
# Nj: 673
# Nm: 500
